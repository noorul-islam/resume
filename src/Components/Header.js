      ...
      <nav id="nav-wrap">
         ...
         <ul id="nav" className="nav">
            ...
            <li><a className="smoothscroll" href="#about">About</a></li>
	         <li><a className="smoothscroll" href="#resume">Scholastic Portfolio</a></li>
            <li><a className="smoothscroll" href="#career">Career Contour</a></li>
            <li><a className="smoothscroll" href="#skill">Skillset</a></li>
            <li><a className="smoothscroll" href="#contact">Certifications</a></li>
